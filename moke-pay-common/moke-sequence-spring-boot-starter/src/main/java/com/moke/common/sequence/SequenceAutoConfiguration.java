package com.moke.common.sequence;

import com.moke.common.sequence.builder.DbSeqBuilder;
import com.moke.common.sequence.builder.RedisSeqBuilder;
import com.moke.common.sequence.builder.SnowflakeSeqBuilder;
import com.moke.common.sequence.properties.SequenceDbProperties;
import com.moke.common.sequence.properties.SequenceRedisProperties;
import com.moke.common.sequence.properties.SequenceSnowflakeProperties;
import com.moke.common.sequence.range.impl.name.DateBizName;
import com.moke.common.sequence.range.impl.name.DefaultBizName;
import com.moke.common.sequence.sequence.Sequence;
 ...
 */
@Configuration
@ComponentScan("com.moke.common.sequence")
